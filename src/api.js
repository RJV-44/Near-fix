...
export const bookingAPI = {
  ...
  updateStatus: (id, data) => request(`/bookings/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
}
...
export const favoriteAPI = {
  ...
  add: (providerId) => request('/favorites', { method: 'POST', body: JSON.stringify({ providerId }) }),
  remove: (providerId) => request(`/favorites/${providerId}`, { method: 'DELETE' }),
}
